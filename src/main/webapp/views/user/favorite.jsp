...
<title>OnlineEntertaimenr Favorite</title>
</head>
	...
	<main class="mt-5">
		<div class="container">
			<section class="h5" style="margin-top: -30px;">
				<h4>
					<strong style="color: rgba(255, 255, 255, 0.7);">Phim đã thích</strong>
				</h4>
				<hr class="bg-light" />
				<div class="row">
					<c:forEach var="item" items="${favorite}">
						<jsp:include page="card_list.jsp">
							...
							<jsp:param value="fas fa-heart-broken" name="icon" />
							<jsp:param value="unlike" name="link" />
						</jsp:include>
					</c:forEach>
				</div>
			</section>
