...
<body class="bg-dark">
			...
			<div class="collapse navbar-collapse" id="navbarExample01">
				...
				<ul class="navbar-nav list-inline">
					...
					<li class="nav-item dropdown"><a class="nav-link"
						href="/OnlineEntertaiment/home" id="navbarDropdown" role="button"
	...
	<section class="mb-5 mt-5">
		...
		<div class="row d-flex justify-content-center">
			<div class="col-md-6">
				<form action="/OnlineEntertaiment/register" method="post">
					<!-- 2 column grid layout with text inputs for the first and last names -->
					<div class="row mb-4">
						<div class="col">
							<div class="form-outline">
								<input name="id" type="text" id="form3Example1" class="form-control text-light" /> <label
						...
						<div class="col">
							<div class="form-outline">
								<input name="fullname" type="text" id="form3Example2" class="form-control text-light" /> <label
					...
					<!-- Password input -->
					<div class="form-outline mb-4">
						<input name="password" type="password" id="form3Example4" class="form-control text-light" />
						<label class="form-label text-light" for="form3Example4">Password</label>
					</div>
					
					<div class="form-outline mb-4">
						<input name="password1" type="password" id="form3Example4" class="form-control text-light" />
						<label class="form-label text-light" for="form3Example4">Confirm Password</label>
					</div>
					<!-- forgot button -->
					<div class="row mb-4">
						<div class="col d-flex justify-content-center">
							<!-- Simple link -->
							<a class="text-muted" href="forgotpass">Forgot password?</a>
						</div>
					</div>
